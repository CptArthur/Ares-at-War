	...
	public class ConfigGeneral{
		...
		public ConfigGeneral LoadSettings(string phase) {
			...
			if(MyAPIGateway.Utilities.FileExistsInWorldStorage("Config-General.xml", typeof(ConfigGeneral)) == true){
				...
				try{
					...
					Logger.Write("Loaded Existing Settings From Config-General.xml. Phase: " + phase, SpawnerDebugEnum.Startup, true);
					return config;
					
				}catch(Exception exc){
					
					Logger.Write("ERROR: Could Not Load Settings From Config-General.xml. Using Default Configuration. Phase: " + phase, SpawnerDebugEnum.Error, true);
				...
				Logger.Write("Config-General.xml Doesn't Exist. Creating Default Configuration. Phase: " + phase, SpawnerDebugEnum.Startup, true);
			...
			try{
				...
				Logger.Write("ERROR: Could Not Create Config-General.xml. Default Settings Will Be Used. Phase: " + phase, SpawnerDebugEnum.Error, true);
		...
		public string SaveSettings(){
			...
			try{
				...
				Logger.Write("Settings In Config-General.xml Updated Successfully!", SpawnerDebugEnum.Settings);
				return "Settings Updated Successfully.";
				
			}catch(Exception exc){
				
				Logger.Write("ERROR: Could Not Save To Config-General.xml. Changes Will Be Lost On World Reload.", SpawnerDebugEnum.Settings);

...
namespace AaW.Factions
{
    ...
    public class FriendlyFactions : MySessionComponentBase
    {
        ...
        public override void BeforeStart()
        {
            ...
            var ASTURAS = MyAPIGateway.Session.Factions.TryGetFactionByTag("ASTURAS");
            ...
            if (UNION == null || THORRIX == null || ITC == null || GC == null || ROS == null || 
                ...
                || CIVILIAN == null || CRUSADERS ==null || SHIPPERS ==null || DRA == null || SUNSETCITY == null || MILITIA==null || ASTURAS==null)
            {

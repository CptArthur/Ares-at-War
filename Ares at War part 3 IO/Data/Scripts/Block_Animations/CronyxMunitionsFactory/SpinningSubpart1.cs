...
namespace CronyxMunitionsFactorySpinAnimation1
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Assembler), false, "CronyxMunitionsFactory")]
    public class CronyxMunitionsFactorySpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixX = Matrix.CreateRotationX(0.01f); // rotation speed for each axis

namespace BigGustave
{
    ...
    internal static class Adam7
    {
        ...
        public static VtupXY GetPixelIndexForScanlineInPass(ImageHeader header, int pass, int scanlineIndex, int indexInScanline)
        {
            ...
            return new VtupXY(precedingCols + columnIndices[actualCol], precedingRows + rows[actualRow]);
        }
    }
}
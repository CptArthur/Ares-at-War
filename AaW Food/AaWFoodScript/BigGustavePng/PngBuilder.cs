...
namespace BigGustave
{
    ...
    public class PngBuilder
    {
        ...
        private readonly List<VtupKeywordData> storedStrings = new List<VtupKeywordData>();
        ...
        public PngBuilder StoreText(string keyword, string text)
        {
            ...
            storedStrings.Add(new VtupKeywordData(keyword, bytes));
        ...
        private static VtupRGBA ColorIntToPixel(int i) => new VtupRGBA((byte)(i >> 16), (byte)(i >> 8), (byte)i, (byte)(i >> 24));

...
namespace ExoticMaterialRefinerySpinAnimation2
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "ExoticMaterialRefinery")]
    public class ExoticMaterialRefinerySpin2 : MyGameLogicComponent
    {
        private const string SUBPART_NAME = "Spin2"; // dummy name without the "subpart_" prefix
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixY = Matrix.CreateRotationY(-0.025f);
